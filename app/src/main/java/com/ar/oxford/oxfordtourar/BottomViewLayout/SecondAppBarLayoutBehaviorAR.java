package com.ar.oxford.oxfordtourar.BottomViewLayout;
...
import com.ar.oxford.oxfordtourar.ARExploreActivity;
import com.ar.oxford.oxfordtourar.R;

/**
 *
 */
public class SecondAppBarLayoutBehaviorAR extends AppBarLayout.ScrollingViewBehavior {
    ...
    public SecondAppBarLayoutBehaviorAR(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        hidden = true;
        isTransparent = true;
    ...
    private void showTitleInToolBar() {
        ...
        /*CharSequence title = ((MapsActivityNew2)mContext).placeNameTextView.getText();*/
        CharSequence title = ""; // KK Changed here to remove the title


        int [] initialLocation = new int[2];
        ((ARExploreActivity)mContext).placeNameTextView.getLocationOnScreen(initialLocation);
    ...
    private void showBackgroundInStatusBar() {
        ...
        {
            Window w = ((ARExploreActivity)mContext).getWindow();
